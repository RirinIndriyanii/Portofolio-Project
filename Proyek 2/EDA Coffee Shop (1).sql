-- 1. Lokasi mana yang memiliki pendapatan terbesar dan berapa jumlah transaksi pada setiap lokasi?
...
-- 2. Kapan (jam, hari) yang memiliki pendapatan paling banyak? 
-- time_period
SELECT 
      CASE 
        ...
        ELSE 'Late Night'
    END time_period,
    ROUND(SUM(sales),2) jumlah_sales
FROM `coffee-shop-20231.coffee_shop.transactions-coffeeeshop`
GROUP BY 1
ORDER BY 2 DESC;


-- hari (berdasarkan sales)
...
-- 3. Produk apa (category, type) yang paling laris dan memiliki kontribusi terbesar terhadap pendapatan?
